...
precession_period = 16825803.979618784 # Period of the precession of the spin axis (+ for direct, - for retrograde precession) (seconds)
...
number_of_locations = 20  # Number of points along the orbit where the Yarkovsky effect is computed
...
maximum_number_of_rotations = 20  # Maximum allowed number of full rotations.
...
#                          Interpolation
# =============================================================================
interpolation = 0 # controls if temperature field is inteporlated over the asteroid or it is given only in the grid cells